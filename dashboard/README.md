...
- ✅ **飞书卡片审批** - 重要操作一键审批，安全可控
  - 饲料采购申请审批
  - 设备维护计划审批
  - 销售订单确认审批
  
- ✅ **智能定时推送** - 重要事项准时提醒，不再错过
  - **07:00** 早间巡查提醒
  - **12:00** 午间投喂提醒
  - **21:00** 晚间数据汇总
...
### 数据迁移
```bash
# 启动 v3.3.5 时会自动从 OpenClaw sessions 同步数据
python start.py
